<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="负责人" prop="instanceId">
        <el-input
    ...
    <el-table v-loading="loading" :data="leaveList">
      <el-table-column label="公司名称" align="center" prop="meetTitle"/>
      <el-table-column label="负责人" align="center" prop="meetApplay"/>
      <!--<el-table-column label="发文单位" align="center" prop="backups1"/>-->
      <el-table-column label="创办时间" align="center" prop="meetParticipants"/>
      ...
      <el-table-column label="经营状况" align="center" prop="backups1"/>
      <el-table-column label="环保情况" align="center" prop="instanceId"/>
      ...
      <el-table-column label="公司经营范围" align="center" prop="meetContent"/>
