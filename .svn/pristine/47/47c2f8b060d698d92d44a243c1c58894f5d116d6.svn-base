  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8" v-if="path=='list'">
      <el-col :span="1.5">
        ...
        <span style="margin-left: 20px">请假流程模型</span>
        <el-select v-model="textForm.docType"   clearable   placeholder="请选择请假流程模型" style="margin-left: 10px">
          <el-option
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="请假类型" v-if="!readonly">
        ...
        <el-form-item label="请假类型" prop="vacationStr" v-if="readonly">
    ...
    <el-dialog title="审批历史" :visible.sync="dialogTableVisible"  width="1000px">
      <ApprovalHistory :instanceId="instanceId" style="width: 95%;padding-left: 2%"></ApprovalHistory>
      <div slot="footer" class="dialog-footer">
        <el-button @click="cancel">取 消</el-button>
      </div>
    </el-dialog>

    <el-dialog title="查看进度" :visible.sync="processImg" style="width: 110%"  width="1200px">
        ...
        this.$refs['form'].validate(valid => {
          if (valid) {
            if (this.form.id != null) {
              ...
              this.form.type = this.textForm.docType;
