<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="leaveList">
      <el-table-column label="会议标题" align="center" prop="meetTitle"/>
      <el-table-column label="发起人" align="center" prop="meetApplay"/>
      <el-table-column label="负责人" align="center" prop="backups1"/>
      <el-table-column label="参会人" align="center" prop="meetParticipants"/>
      ...
      <el-table-column label="会议主要内容" align="center" prop="meetContent"/>
