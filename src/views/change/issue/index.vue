<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :rules="addRules" :inline="true" class="demo-form-inline">
      ...
      <el-row :gutter="20">
        <el-col :span="6" :offset="1">
          <el-form-item label="收文单位" prop="acceptCompany" >
            <!--<el-select v-model="queryParams.acceptCompany"   clearable multiple collapse-tags  placeholder="请选择收文单位">
              <el-option
           ...
           <!-- <el-select v-model="queryParams.acceptCompany" placeholder="请选择" @change="contentChange1">
              <el-option
                v-for="item in threeSendList"
                :key="item.deptId"
                :label="item.deptName"
      ...
      <el-form-item>
        <el-button type="cyan"  size="mini" @click="submitForm">确定</el-button>
...
<script>
  ...
  import {
    meetList,addMeet,submitApply,taskList,getMeet,uploadFile,sendDocument,getlistDept
  ...
  export default {
    ...
    /*  /!** 搜索按钮操作 *!/
      ...
      submitForm() {
        ...
        console.log('Hjkh 聚隆科技了',this.firstSendAccounts)
        let acceptName='';
        let acceptUser='';
        ...
        sendDocument(this.queryParams).then(response => {
          if (response.code === 200) {
